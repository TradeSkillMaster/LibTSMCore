...
The [LibTSMCore](https://github.com/TradeSkillMaster/LibTSMCore) defines a framework for
...
namespace will be added to your local addon table. General convention is to define a component
